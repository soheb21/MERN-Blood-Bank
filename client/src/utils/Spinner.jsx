...
const Spinner = () => {
    return (
        <div aria-label="Loading..." role="status" className="flex items-center justify-center h-80 w-full space-x-2">
            ...
            <span className="text-4xl font-medium text-purple-500">Loading...</span>
        </div>
